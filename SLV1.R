...
library(doMC)  # 
registerDoMC(120)  # register Multi Cores
...
sim.slv1.graph <- function(graph, alpha0 = 1, beta0 = NULL, gamma0 = 1, sigma0 = 0.05,
...
# Sigma = diag(0.05, m)
# Xinit = c(1, 1, 1)
# slv1.out = sim.slv1(m = m, Alpha = Alpha, Theta = Theta, Sigma = Sigma, Xinit = Xinit)
